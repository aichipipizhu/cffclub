...
test("formats daily order code sequence with four-digit suffix", () => {
  assert.equal(formatOrderCode("20260525", 1), "202605250001");
  assert.equal(formatOrderCode("20260525", 12345), "2026052512345");
});
